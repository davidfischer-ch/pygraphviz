...
With PyGraphviz you can create, edit, read, write, and draw graphs using Python to access \
the Graphviz graph data structure and layout algorithms. PyGraphviz provides a similar \
programming interface to NetworkX (http://networkx.github.io).
"""
license = 'BSD'
...
authors = {'Hagberg': ('Aric Hagberg', 'aric.hagberg@gmail.com'),
           ...
           'Fischer': ('David Fischer', 'david.fischer.ch@gmail.com')
           }
